...
HD_PWD='C:/Users/rewal/Desktop/RTL_QAM-master/QAM_Vivado/QAM_Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log QAM_Hierarchical.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source QAM_Hierarchical.tcl -notrace
