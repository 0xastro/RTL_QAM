...
HD_PWD='C:/Users/rewal/Desktop/RTL_QAM-master/QAM_Vivado/QAM_Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QAM_Hierarchical.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QAM_Hierarchical.tcl
